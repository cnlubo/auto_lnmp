#!/bin/bash
# @Author: cnak47
# @Date: 2018-06-08 10:26:58
# @LastEditors: cnak47
# @LastEditTime: 2020-11-08 20:49:37
# @Description:
# #
...
Install_Docker() {
    ...
    if [ ! -f /bin/docker ]; then
        ...
        if [ "$SHELL" = '/usr/local/bin/zsh' ] || [ "$SHELL" = '/bin/zsh' ]; then
            ...
            curl -L https://github.com/docker/compose/blob/$(docker-compose version --short)/contrib/completion/zsh/_docker-compose > ~/.zsh/completion/_docker-compose
